...
export const Portfolio: React.FC = () => {
  ...
  const categories = ["All", "Web Development", "Graphic Design", "Photography", "Social Media"];

  const projects = [
    {
      id: 1,
      title: "Wedding Cattering Website With Recomendation System",
      category: "Web Development",
      image: WebCate,
      description: "Modern wedding catering website with a recommendation system built using Laravel and Tailwind CSS.",
    },
    {
      id: 2,
      ...
      image: DesignGrap,
      description: "Modern branding package including logo, typography, and poster design.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      category: "Photography",
      image: pasangan,
      description: "Landscape photography capturing Couple during pregnancy.",
    },
    {
      id: 5,
      ...
      image: IG,
      description: "Cohesive 6-post grid design for a Wedding Catering Business.",
    }
  ];
  ...
  return (
    <section id="portofolio" className="py-24 bg-slate-50/50 dark:bg-slate-900/50 relative">
